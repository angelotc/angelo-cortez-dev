...
In this post, I'll walk you through how I turned property listings into vectors for [Nippon Homes](https://nipponhomes.com/) and used them to surface homes you're likely to view. Currently, NipponHomes has around 150k active listings at any given time.
...
$$
\vec{p}_{\text{user}} = \frac{1}{3}(\vec{v}_1 + \vec{v}_2 + \vec{v}_3) can 
$$
